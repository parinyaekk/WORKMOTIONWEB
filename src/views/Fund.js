...
class Fund extends React.Component {
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-6">
                              <div class="float-right">
                                <button class="btn btn-outline-info" type="button" style={{ width: '100%' }} data-toggle="modal" data-target="#PopData" data-backdrop="static" onClick={() => null}><Plus />&nbsp; Add Fund</button>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="editmodal-dialog">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h1>{this.state.txtTopicPopData}&nbsp;Fund</h1>
                          ...
                          <div className="row">
                            <div className="form-group col-md-12">
                              <div className="float-right">
                                <input type="submit" value={this.state.txtTopicPopData + " Data"} className="btn btn-success" style={{marginTop:"24px"}} onClick={() => this.UpdateFund()}/>
                              </div>
                            </div>
                          </div>
                      </div>
  ...
  async GetFundTable() {
    ...
    await axios
      .get(`${APIUrl}Portfolio/GetFundTable`)
      .then(response => {
        if (response.data.status == 0) {
