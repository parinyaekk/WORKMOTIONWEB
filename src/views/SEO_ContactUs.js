...
class SEO_ContactUs extends React.Component {
   render() {
    return (
      <LoadingOverlay
        styles={{
                        ...
                        <div className="card-header">
                          <div className="row">
                            <div className="col-md-6">
                              <h1>{this.state.txtTopicPopData}&nbsp;SEO Contact</h1>
                            </div>
                            <div className="col-md-6">
                          ...
                          <div className="modal-body">
                            <div className="row">
                              ...
                              <div className="form-group center col-md-12" style={{ paddingLeft: '30px', paddingRight: '30px' }}>
                                ...
                                />                              </div>
                              <div className="form-group center col-md-12" style={{ paddingLeft: '30px', paddingRight: '30px' }}>
                                <label className="small mb-1">Contact Meta Description</label>
  ...
  async componentWillMount() {
    await this.GetDataSEOContactUs();
  }
  ...
  async GetDataSEOContactUs() {
    var _this = this;
    _this.setState({ loading: true });
    await axios
      .get(`${APIUrl}ContactUs/GetDataSEOContactUs`)
      .then(response => {
